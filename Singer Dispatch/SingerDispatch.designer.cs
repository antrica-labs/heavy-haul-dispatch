...
namespace SingerDispatch
{
    ...
    partial void OnPermitTimeChanged();
		...
		[Column(Storage="_Issuer", DbType="VarChar(255)")]
		...
		[Column(Storage="_PermitType", DbType="VarChar(255)")]
		...
		[Column(Storage="_Conditions", DbType="VarChar(1000)")]
		...
		[Column(Storage="_PermitTime", DbType="DateTime")]
    ...
    partial void OnNotesChanged();
		...
		[Column(Storage="_ThirdPartyServiceTypeID", DbType="BigInt")]
	...
	[Table(Name="dbo.ThirdPartyServiceType")]
    ...
    partial void OnOutOfServiceDateChanged();
		...
		[Column(Storage="_ClassID", DbType="BigInt")]
	...
	[Table(Name="dbo.EquipmentClasses")]
