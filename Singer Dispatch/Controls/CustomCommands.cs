...
namespace SingerDispatch.Controls
{
    public static class CustomCommands
    {
        ...
        public static RoutedCommand LoadsLookupCommand = new RoutedCommand();
        ...
        static CustomCommands()
        {
            ...
            LoadsLookupCommand.InputGestures.Add(new KeyGesture(Key.L, ModifierKeys.Shift | ModifierKeys.Control));
