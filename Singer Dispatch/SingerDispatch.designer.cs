...
namespace SingerDispatch
{
    ...
    partial void OnIsPrintedChanged();
		...
		[Association(Name="Quote_QuoteCondition", Storage="_QuoteConditions", ThisKey="ID", OtherKey="QuoteID")]
    ...
    partial void OnLineChanged();
		...
		[Association(Name="Condition_QuoteCondition", Storage="_QuoteConditions", ThisKey="ID", OtherKey="ConditionID")]
		public EntitySet<QuoteCondition> QuoteConditions
		{
			get
			{
    ...
    partial void OnConditionIDChanged();
		...
		[Association(Name="Quote_QuoteCondition", Storage="_Quote", ThisKey="QuoteID", OtherKey="ID", IsForeignKey=true)]
		public Quote Quote
		{
			get
			{
		...
		[Association(Name="Condition_QuoteCondition", Storage="_Condition", ThisKey="ConditionID", OtherKey="ID", IsForeignKey=true)]
