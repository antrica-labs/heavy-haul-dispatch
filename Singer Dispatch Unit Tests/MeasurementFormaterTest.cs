...
namespace Singer_Dispatch_Unit_Tests
{
    
    
    /// <summary>
    ///This is a test class for MeasurementFormaterTest and is intended
    ///to contain all MeasurementFormaterTest Unit Tests
    ///</summary>
    [TestClass()]
    public class MeasurementFormaterTest
    {
